...
public class ServerBootstrap extends AbstractBootstrap<ServerBootstrap, ServerChannel,
    ...
    /**
     * Step:
     * 1.创建channelpromise,主要是封装了channel和eventLoop;
     * 2.设置options属性到channel和attrs到channel;
     * 3.向channel的pipeline里添加ChannelInitializer,在channel注册到eventLoop时执行;
     *
     * {
     *    ???question:ServerBootstrapAcceptor???
     * }
     */
    @Override

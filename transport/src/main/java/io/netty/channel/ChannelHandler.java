 ...
 *
 * 利用channelhandlerContext pipeline可以从上游向下游传递事件和处理信息;
 *
...
public interface ChannelHandler {
     ...
     *
     * 在{@link ChannelHandler}添加到实际上下文并准备好处理事件后调用。
     *
     * 添加到pipeline时会执行此方法;
     */
     ...
     *
     * 如果这个handler可以在多线程下执行,没有竞争条件,那么可以添加这个注解,并且可以添加到多个pipeline中多次;
     *
     * <p>
     * If this annotation is not specified, you have to create a new handler
     ...
     *
     * 在channelRead执行完执行,如果channelRead异常,那么这个方法不会执行;
     */
    @Skip

 ...
 * provided here.
 *
 * 通过调用这里面的某个方法会通知在相同pipeline里的最近的hnadler;
 *
 ...
 *
 * 可以获取pipeline并进行handler的添加删除修改等操作;
 *
 ...
 *
 * 可以保留channelhandlercontext,以后再用;
 *
 * <pre>
 ...
 *         <b>this.ctx = ctx;</b> // 在handler中保留此时状态的channelhandlercontext;
 *     }
 *
 *     public void login(String username, password) {
 *         ctx.write(new LoginMessage(username, password)); // 某个时候再用;
 *     }
 *     ...
 * }
 * </pre>
